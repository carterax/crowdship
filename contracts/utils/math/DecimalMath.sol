...
library DecimalMath {
    ...
    /// @dev Equal to.
    function eq(UFixed memory x, uint256 y) internal pure returns (bool) {
        return x.value == y.mul(UNIT);
    }

    /// @dev Equal to.
    function eq(uint256 x, UFixed memory y) internal pure returns (bool) {
    ...
    /// @dev Greater than.
    function gt(UFixed memory x, uint256 y) internal pure returns (bool) {
        return x.value > y.mul(UNIT);
    }

    /// @dev Greater than.
    function gt(uint256 x, UFixed memory y) internal pure returns (bool) {
        return x.mul(UNIT) > y.value;
    }

    /// @dev Greater or equal.
    function geq(UFixed memory x, UFixed memory y)
        internal
        pure
        returns (bool)
    {
    ...
    /// @dev Greater or equal.
    function geq(UFixed memory x, uint256 y) internal pure returns (bool) {
        return x.value >= y.mul(UNIT);
    }

    /// @dev Greater or equal.
    function geq(uint256 x, UFixed memory y) internal pure returns (bool) {
        return x.mul(UNIT) >= y.value;
    }
    ...
    /// @dev Less than.
    function lt(UFixed memory x, uint256 y) internal pure returns (bool) {
        return x.value < y.mul(UNIT);
    }

    /// @dev Less than.
    function lt(uint256 x, UFixed memory y) internal pure returns (bool) {
        return x.mul(UNIT) < y.value;
    }

    /// @dev Less or equal.
    function leq(UFixed memory x, UFixed memory y)
        internal
        pure
        returns (bool)
    {
    ...
    /// @dev Less or equal.
    function leq(uint256 x, UFixed memory y) internal pure returns (bool) {
        return x.mul(UNIT) <= y.value;
    }

    /// @dev Less or equal.
    function leq(UFixed memory x, uint256 y) internal pure returns (bool) {
        return x.value <= y.mul(UNIT);
    }
    ...
    function muld(UFixed memory x, UFixed memory y)
        internal
        pure
        returns (UFixed memory)
    {
        return UFixed({value: muld(x.value, y)});
    }
    ...
    /// @return A fixed point number.
    function muld(UFixed memory x, uint256 y)
        internal
        pure
        returns (UFixed memory)
    {
    ...
    /// @param y A fixed point number.
    /// @return A fixed point number.
    function divd(UFixed memory x, UFixed memory y)
        internal
        pure
        returns (UFixed memory)
    {
        return UFixed({value: divd(x.value, y)});
    }
    ...
    /// @param y An unsigned integer.
    /// @return A fixed point number.
    function divd(UFixed memory x, uint256 y)
        internal
        pure
        returns (UFixed memory)
    {
    ...
    /// @param y A fixed point number.
    /// @return A fixed point number.
    function addd(UFixed memory x, UFixed memory y)
        internal
        pure
        returns (UFixed memory)
    {
        return UFixed({value: x.value.add(y.value)});
    }
    ...
    /// @param y An unsigned integer.
    /// @return A fixed point number.
    function addd(UFixed memory x, uint256 y)
        internal
        pure
        returns (UFixed memory)
    {
    ...
    /// @param y A fixed point number.
    /// @return A fixed point number.
    function subd(UFixed memory x, UFixed memory y)
        internal
        pure
        returns (UFixed memory)
    {
        return UFixed({value: x.value.sub(y.value)});
    }
    ...
    /// @param y An unsigned integer.
    /// @return A fixed point number.
    function subd(UFixed memory x, uint256 y)
        internal
        pure
        returns (UFixed memory)
    {
    ...
    /// @param y A fixed point number.
    /// @return A fixed point number.
    function subd(uint256 x, UFixed memory y)
        internal
        pure
        returns (UFixed memory)
    {
    ...
    /// @param y A fixed point number.
    /// @return An unsigned integer.
    function divdrup(uint256 x, UFixed memory y)
        internal
        pure
        returns (uint256)
    {
    ...
    /// @param y A fixed point number.
    /// @return An unsigned integer.
    function muldrup(uint256 x, UFixed memory y)
        internal
        pure
        returns (uint256)
    {
    ...
    /// @return An unsigned integer.
    function powd(UFixed memory x, uint256 n)
        internal
        pure
        returns (UFixed memory)
    {
